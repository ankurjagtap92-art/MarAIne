    ...
    <aside className="fixed left-0 top-0 z-50 flex min-h-screen w-64 flex-col border-r border-ocean-line bg-ocean-navy/80 backdrop-blur-xl">
      ...
      <div className="border-b border-ocean-line px-6 py-6">
        <Link href="/dashboard" className="flex items-center gap-3 group">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-cyan-500 text-white shadow-lg shadow-orange-500/20 group-hover:scale-105 transition-transform">
            <IconAnchor className="animate-float" width={20} height={20} />
          </div>
          <div className="min-w-0">
            <h1 className="text-[16px] font-bold leading-tight text-white tracking-tight flex items-center">
              <span>Sea</span>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-cyan-400">Vision</span>
            </h1>
            <p className="text-[10px] uppercase font-mono tracking-wider text-orange-400/90">Maritime Intelligence</p>
          </div>
        </Link>
      </div>
